...
| --- | --- | --- |
| R scripts | `code/` | Yes |
| Report and figures | `rapport.tex, figures/` | Yes |
...
Report it privately by email to [romainben31@gmail.com](mailto:romainben31@gmail.com), or through GitHub's private vulnerability reporting if the owner of the repository has enabled it: [report a vulnerability](https://github.com/evrardlecureur/ProbaProjet/security/advisories/new).
...
* the R scripts, which only read the datasets provided by the instructor with `load()` and `source()`;
...
* **Dependabot** version updates for the GitHub Actions, grouped by patch and minor updates.
